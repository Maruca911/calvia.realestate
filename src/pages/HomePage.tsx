    ...
    <>
      ...
      <section className="py-20 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div
            ref={blogRef}
            className={`grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-10 transition-all duration-700 ${
          ...
          >
            {featured.map((post) => (
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 text-xs text-grey-light mb-3">
                    <Clock className="w-3 h-3" />
                    {post.readTime}
                  </div>
                  <h3 className="font-heading text-lg font-bold text-black mb-2 group-hover:text-dark-blue transition-colors leading-snug">
                    {post.title}
                  </h3>
                  <p className="text-grey text-sm leading-relaxed mb-4 line-clamp-2">
                    {post.excerpt}
                  </p>
          ...
          <div className="text-center">
            <button
              ...
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-dark-blue/5 text-dark-blue font-semibold rounded-lg hover:bg-dark-blue hover:text-white transition-all duration-300"
            >
              View All Articles
              <ArrowRight className="w-4 h-4" />
            </button>
      ...
      <section className="py-20 md:py-24 bg-beige">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-grey text-lg mb-10 max-w-xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="w-full sm:w-auto px-10 py-4 bg-dark-blue text-white font-semibold rounded-lg text-lg transition-all duration-300 hover:bg-dark-blue-light hover:shadow-[0_0_30px_rgba(0,31,63,0.3)] hover:-translate-y-0.5"
            >
              Find Your Dream Home
            </button>
            <button
              onClick={() => navigate('/sellers')}
              className="w-full sm:w-auto px-10 py-4 bg-white text-dark-blue font-semibold rounded-lg text-lg border-2 border-dark-blue transition-all duration-300 hover:bg-dark-blue hover:text-white hover:shadow-[0_0_30px_rgba(0,31,63,0.3)] hover:-translate-y-0.5"
            >
              I'm a Home Owner
            </button>
          </div>
